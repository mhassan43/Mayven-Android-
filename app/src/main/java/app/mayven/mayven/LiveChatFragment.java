    ...
    public class LiveChatFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
        ...
        private String gid, gname, name,type;
        private String temp;
        ...
        public LiveChatFragment(String s, String s1, String name,String type) {
            this.gid = s;
            this.gname = s1;
            this.name = name;
            this.type = type;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (gname.equals("") || gname == null){
                ArrayList<Group> g =  chatGroupArray.getGroupSave();
                for (Group i : g){
                    if (i.getDocId().equals(gid)){
                        for (String f : i.getMembers()){
                            if (!f.equals(signedInUsername)){
                                groupName.setText(f);
                            }
                        }
                    }
            ...
            switch (nightModeFlags) {
                case Configuration.UI_MODE_NIGHT_YES:
                    ...
                    groupMembers.setColorFilter(Color.WHITE);
        ...
        private Task<String> addMessage(String docId) {
            ...
            return mFunctions
                    .getHttpsCallable("chatNotifications")
                    .call(data)
