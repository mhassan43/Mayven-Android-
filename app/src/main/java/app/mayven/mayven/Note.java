...
public class Note {
    ...
    public Note(int timestamp, String ownerId, String text, String ownerName, String imageURL, List<String> replies, List<String>
            usersLiked, int likes, int replyCount, String documentId, String originalPost, List<String> reports,String type, String link,String color/*DocumentSnapshot documentSnapshot*/) {
