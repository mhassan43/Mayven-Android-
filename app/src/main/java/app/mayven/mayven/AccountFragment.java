...
public class AccountFragment extends Fragment {
    ...
    private RelativeLayout deleteAcc;
    private RelativeLayout signOut;

    private TextView name,pname,pclassOf;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pic4 = v.findViewById(R.id.pic4);
        pic5 = v.findViewById(R.id.pic5);
        pic6 = v.findViewById(R.id.pic6);
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final PopupMenu popup = new PopupMenu(wrapper, settingButton);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(main.pointsListner != null){
                    main.pointsListner.remove();
                }
        ...
        switch (nightModeFlags) {
            case Configuration.UI_MODE_NIGHT_YES:
                ...
                //pclassOf.setTextColor(Color.WHITE);
                //pname.setTextColor(Color.WHITE);

                //aboutUs.setTextColor(Color.WHITE);

                pic.setColorFilter(getResources().getColor(R.color.gnt_white));
                pic2.setColorFilter(getResources().getColor(R.color.gnt_white));
                pic3.setColorFilter(getResources().getColor(R.color.gnt_white));
                pic4.setColorFilter(getResources().getColor(R.color.gnt_red));
                pic5.setColorFilter(getResources().getColor(R.color.gnt_white));
                pic6.setColorFilter(getResources().getColor(R.color.gnt_white));
