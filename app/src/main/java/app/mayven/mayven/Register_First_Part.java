...
public class Register_First_Part extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<String> extension = getIntent().getStringArrayListExtra("extension");
        ...
        switch (nightModeFlags) {
            case Configuration.UI_MODE_NIGHT_YES:
                ...
                programp.setTextColor(Color.WHITE);
                name.setTextColor(Color.WHITE);
                ownerId.setTextColor(Color.WHITE);
                break;
                    ...
                    userRef
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            if (document.exists()) {
                                ...
                                Log.d("1234","code = " + code + " school " + schoolId);
